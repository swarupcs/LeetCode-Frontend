...
export default function ProblemSheet() {
  ...
  const filteredSheets = sdeSheets.filter(
    (sheet) =>
              ...
              <CardHeader>
                ...
                <div className='flex items-center space-x-2 mt-3'>
                  <Avatar className='h-6 w-6'>
                    <AvatarImage
                      src={sheet.authorAvatar || '/placeholder.svg'}
                    />
                    <AvatarFallback>{sheet.author[0]}</AvatarFallback>
                  </Avatar>
                  <span className='text-sm text-gray-600'>{sheet.author}</span>
                </div>
              </CardHeader>
          ...
          <DialogContent className='sm:max-w-[525px]'>
            ...
            <div className='grid gap-4 py-4'>
              <div className='grid gap-2'>
                ...
                <Input id='problem-title' placeholder='Enter problem title' />
              </div>
              <div className='grid gap-2'>
            ...
            <DialogFooter>
              <Button type='submit' onClick={() => setAddProblemOpen(false)}>
                Add Problem
              </Button>
            </DialogFooter>
          </DialogContent>
