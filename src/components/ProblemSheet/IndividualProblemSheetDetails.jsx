            ...
            <Table>
              ...
              <TableBody>
                {filteredProblems.map((problemItem) => (
                  <TableRow key={problemItem.id} className='hover:bg-gray-50'>
                    <TableCell>
                      <Button
                        variant='ghost'
                        size='sm'
                        onClick={() => toggleProblemCompletion(problemItem.id)}
                    ...
                    <TableCell>
                      <div className='flex flex-wrap gap-1'>
                        {problemItem.problem.tags.slice(0, 2).map((tag) => (
                          <Badge
                            key={tag}
                            variant='outline'
                            className='text-xs'
