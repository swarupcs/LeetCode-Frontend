...
import type { CreateProblemPayload, CreateProblemResponse, ApiError } from '@/types/problem.types';
 
export const useCreateProblem = () => {
  const queryClient = useQueryClient();
 
  const mutation = useMutation<CreateProblemResponse, ApiError, CreateProblemPayload>({
